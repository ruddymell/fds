...
REAL(EB) :: VEG_SV,VEG_MOISTURE,VEG_CHAR_FRACTION,VEG_DRAG_CONSTANT,VEG_DENSITY,VEG_BULK_DENSITY, &
            ...
            VEG_FUEL_MPV_MIN,VEG_MOIST_MPV_MIN,VEG_CHAR_ENTHALPY_FRACTION,VEG_ASH_FRACTION
...
LOGICAL :: VEG_REMOVE_CHARRED,VEG_STEM,VEG_CHAR_OXIDATION,VEG_IGNITED,VEG_HCONV_CYLLAM,VEG_WFDS_FE
...
NAMELIST /PART/ AGE,BREAKUP,BREAKUP_CNF_RAMP_ID,BREAKUP_DISTRIBUTION,BREAKUP_GAMMA_D,BREAKUP_RATIO,&
                ...
                VEG_BETA_CHAR,VEG_NU_O2_CHAR,VEG_CHAROX_RATE_MAX,VEG_HCONV_CYLLAM,VEG_WFDS_FE
