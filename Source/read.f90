...
LOGICAL :: VEGETATION,VEG_NO_BURN, &
...
NAMELIST /SURF/ ADIABATIC,BACKING,BURN_AWAY,CELL_SIZE_FACTOR,C_FORCED_CONSTANT,C_FORCED_PR_EXP,C_FORCED_RE,C_FORCED_RE_EXP,&
                ...
                VEGETATION,VEG_DRAG_CONSTANT,VEG_HCONV_CYLRE,VEG_HCONV_CYLLAM,FIRELINE_MLR_MAX, &
...
REAL(EB) :: CROWN_BASE_HEIGHT,CROWN_BASE_WIDTH,TREE_HEIGHT
LOGICAL  :: OUTPUT_TREE
CHARACTER(30) :: LABEL
...
INIT_LOOP: DO N=1,N_INIT_READ+N_INIT_RESERVED
   ...
   IF (SHAPE=='CONE' .OR. SHAPE=='RING') THEN
      ...
      IF (CROWN_BASE_WIDTH > 0._EB) THEN !WFDS6, needed if XYZ is a location on the terrain
