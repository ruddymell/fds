...
LOGICAL :: VEG_REMOVE_CHARRED,VEG_STEM,VEG_CHAR_OXIDATION,VEG_IGNITED,VEG_HCONV_CYLLAM,VEG_HCONV_CYLRE,VEG_HCONV_CYLMAX, &
           VEG_HCONV_CYLMIXED,VEG_WFDS_FE,VEG_CHAR_OX_CO2GAIN_O2LOSS
...
NAMELIST /PART/ AGE,BREAKUP,BREAKUP_CNF_RAMP_ID,BREAKUP_DISTRIBUTION,BREAKUP_GAMMA_D,BREAKUP_RATIO,&
                ...
                VEG_HCONV_CYLMIXED,VEG_WFDS_FE,VEG_VOLUME_FRACTION,VEG_CHAR_OX_CO2GAIN_O2LOSS
...
VEG_CHAR_OX_CO2GAIN_O2LOSS = .FALSE. !include CO2 production and O2 consumption during char oxidation
