...
SF%ONE_D_REALS_ARRAY_SIZE(21) = SF%NVEG_L                    ! VEG_FUELMASS_L
SF%ONE_D_REALS_ARRAY_SIZE(22) = SF%NVEG_L                    ! VEG_MOISTMASS_L
SF%ONE_D_REALS_ARRAY_SIZE(23) = SF%NVEG_L+2                  ! VEG_TMP_L
SF%ONE_D_REALS_ARRAY_SIZE(24) = SF%NVEG_L                    ! VEG_CHARMASS_L
SF%ONE_D_REALS_ARRAY_SIZE(25) = SF%NVEG_L                    ! VEG_ASHMASS_L

SF%ONE_D_INTEGERS_ARRAY_SIZE(1) = SF%N_LAYERS           ! N_LAYER_CELLS

SF%N_ONE_D_STORAGE_REALS    = N_ONE_D_SCALAR_REALS    + SUM(SF%ONE_D_REALS_ARRAY_SIZE(1:25))
...
LP%VEG_WFDS_FE       => OS%LOGICALS( 5,STORAGE_INDEX) ; IF (NEW) LP%VEG_WFDS_FE   = .FALSE.
...
LP%VEG_KAPPA         => OS%REALS(18,STORAGE_INDEX) ; IF (NEW) LP%VEG_KAPPA         = 0._EB
LP%VEG_EMISS         => OS%REALS(19,STORAGE_INDEX) ; IF (NEW) LP%VEG_EMISS         = 0._EB
LP%VEG_DIVQC         => OS%REALS(20,STORAGE_INDEX) ; IF (NEW) LP%VEG_DIVQC         = 0._EB
LP%VEG_DIVQR         => OS%REALS(21,STORAGE_INDEX) ; IF (NEW) LP%VEG_DIVQR         = 0._EB
LP%VEG_PACKING_RATIO => OS%REALS(22,STORAGE_INDEX) ; IF (NEW) LP%VEG_PACKING_RATIO = 0._EB
LP%VEG_FUEL_MASS     => OS%REALS(23,STORAGE_INDEX) ; IF (NEW) LP%VEG_FUEL_MASS     = 0._EB
LP%VEG_MOIST_MASS    => OS%REALS(24,STORAGE_INDEX) ; IF (NEW) LP%VEG_MOIST_MASS    = 0._EB
LP%VEG_CHAR_MASS     => OS%REALS(25,STORAGE_INDEX) ; IF (NEW) LP%VEG_CHAR_MASS     = 0._EB
LP%VEG_ASH_MASS      => OS%REALS(26,STORAGE_INDEX) ; IF (NEW) LP%VEG_ASH_MASS      = 0._EB
LP%VEG_SV            => OS%REALS(27,STORAGE_INDEX) ; IF (NEW) LP%VEG_SV            = 0._EB
LP%VEG_MLR           => OS%REALS(28,STORAGE_INDEX) ; IF (NEW) LP%VEG_MLR           = 0._EB
LP%VEG_VOLFRACTION   => OS%REALS(29,STORAGE_INDEX) ; IF (NEW) LP%VEG_VOLFRACTION   = 0._EB
LP%VEG_Q_CHAROX      => OS%REALS(30,STORAGE_INDEX) ; IF (NEW) LP%VEG_Q_CHAROX      = 0._EB
LP%VEG_TMP           => OS%REALS(31,STORAGE_INDEX) ; IF (NEW) LP%VEG_TMP           = 0._EB
...
ONE_D%VEG_HEIGHT      => OS%REALS(RC+34,STORAGE_INDEX) ; IF (NEW) ONE_D%VEG_HEIGHT      = 0._EB
...
ONE_D%VEG_FUELMASS_L(1:I2-I1+1) => OS%REALS(I1:I2,STORAGE_INDEX)
IF (NEW) ONE_D%VEG_FUELMASS_L(1:I2-I1+1) = 0._EB

I1 = I2+1 ; I2 = I1 + SF%ONE_D_REALS_ARRAY_SIZE(22) - 1
ONE_D%VEG_MOISTMASS_L(1:I2-I1+1) => OS%REALS(I1:I2,STORAGE_INDEX)
IF (NEW) ONE_D%VEG_MOISTMASS_L(1:I2-I1+1) = 0._EB

I1 = I2+1 ; I2 = I1 + SF%ONE_D_REALS_ARRAY_SIZE(23) - 1
ONE_D%VEG_TMP_L(1:I2-I1+1) => OS%REALS(I1:I2,STORAGE_INDEX)
IF (NEW) ONE_D%VEG_TMP_L(1:I2-I1+1) = 0._EB

I1 = I2+1 ; I2 = I1 + SF%ONE_D_REALS_ARRAY_SIZE(24) - 1
ONE_D%VEG_CHARMASS_L(1:I2-I1+1) => OS%REALS(I1:I2,STORAGE_INDEX)
IF (NEW) ONE_D%VEG_CHARMASS_L(1:I2-I1+1) = 0._EB

I1 = I2+1 ; I2 = I1 + SF%ONE_D_REALS_ARRAY_SIZE(25) - 1
ONE_D%VEG_ASHMASS_L(1:I2-I1+1) => OS%REALS(I1:I2,STORAGE_INDEX)
IF (NEW) ONE_D%VEG_ASHMASS_L(1:I2-I1+1) = 0._EB
