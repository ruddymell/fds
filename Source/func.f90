...
SF%ONE_D_REALS_ARRAY_SIZE(18) = SF%NVEG_L                    ! VEG_FUELMASS_L
SF%ONE_D_REALS_ARRAY_SIZE(19) = SF%NVEG_L                    ! VEG_MOISTMASS_L
SF%ONE_D_REALS_ARRAY_SIZE(20) = SF%NVEG_L+2                  ! VEG_TMP_L
SF%ONE_D_REALS_ARRAY_SIZE(21) = SF%NVEG_L                    ! VEG_CHARMASS_L
SF%ONE_D_REALS_ARRAY_SIZE(22) = SF%NVEG_L                    ! VEG_ASHMASS_L
