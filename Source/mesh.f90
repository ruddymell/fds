...
TYPE MESH_TYPE
   ...
   REAL(EB) :: VEG_CLOCK_BC,VEG_CLOCK_FE !BF and FE WFDS veg
...
REAL(EB), POINTER :: VEG_CLOCK_BC,VEG_CLOCK_FE  !BF and FE WFDS veg
...
!For WFDS boundary fuel BF and FE vegetation or level set
VEG_CLOCK_BC  =>M%VEG_CLOCK_BC
VEG_CLOCK_FE  =>M%VEG_CLOCK_FE
