...
INTEGER, PARAMETER :: VEG_WFDS_FE_DRAG=6               !< Flag for LPC\%DRAG_LAW: Special drag model for veg WFDS drag model
...
LOGICAL :: WFDS_BNDRYFUEL=.FALSE.,WFDS_FE=.FALSE.   !Defaults for WFDS veg model
